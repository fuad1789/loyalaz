    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#features" className="text-gray-600 hover:text-gray-900 transition-colors">Xüsusiyyətlər</a>
              <a href="#how-it-works" className="text-gray-600 hover:text-gray-900 transition-colors">Necə işləyir</a>
              <a href="#pricing" className="text-gray-600 hover:text-gray-900 transition-colors">Qiymətlər</a>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-200 mb-8 animate-fade-in">
              ...
              <span className="text-sm font-medium text-gray-600">Azərbaycanın ilk rəqəmsal sadiqlit platforması</span>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
              Biznesiniz üçün smartfon əsaslı sadiqlit kartı həlli. 
              Kağız kartlara son, rəqəmsal gələcəyə xoş gəldiniz.
            </p>
          ...
          <div className="flex flex-col items-center justify-center mb-16 animate-scale-in" style={{ animationDelay: '0.3s' }}>
            <Link href="/demo" className="relative cursor-pointer group">
              ...
              <div className="relative bg-white p-6 rounded-3xl shadow-2xl border border-gray-100 transform rotate-3 group-hover:rotate-0 transition-transform duration-500">
                <div className="w-48 h-48 bg-white rounded-2xl p-3 flex items-center justify-center">
                  {/* Real QR Code */}
                  <QRCodeSVG 
                    value={typeof window !== 'undefined' ? `${window.location.origin}/demo` : '/demo'}
                    size={180}
                    level="H"
                    includeMargin={false}
                    fgColor="#1f2937"
                ...
                <div className="absolute inset-0 bg-primary-500/0 group-hover:bg-primary-500/5 rounded-3xl transition-colors flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl shadow-lg">
                    <span className="text-primary-600 font-medium text-sm">Demo-ya keçid →</span>
                  </div>
                </div>
              </div>
            </Link>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-4 border border-gray-100 transform hover:-translate-y-2 transition-transform">
                      <div className="bg-gradient-to-br from-primary-50 to-white rounded-2xl p-6 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">QR Oxut</h3>
                        <p className="text-sm text-gray-500">Sadə bir toxunuşla xal əlavə edin</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-4 border border-gray-100 transform hover:-translate-y-2 transition-transform">
                      <div className="bg-gradient-to-br from-accent-50 to-white rounded-2xl p-6 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">Xallar</h3>
                        <p className="text-sm text-gray-500">4/6 xal toplandı</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-4 border border-gray-100 transform hover:-translate-y-2 transition-transform">
                      <div className="bg-gradient-to-br from-emerald-50 to-white rounded-2xl p-6 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">Hədiyyə!</h3>
                        <p className="text-sm text-gray-500">6 xal = 1 pulsuz nahar</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-8 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 text-center mb-4">
          <h3 className="text-lg font-semibold text-gray-500">Bizə güvənən məkanlar</h3>
        </div>
        <TrustedMarquee />
      </section>
            ...
            {[
              {
                ...
                description: 'Hər kart üçün unikal QR kod. Sadə və sürətli skan etmə.',
                color: 'primary',
              },
              {
                icon: Smartphone,
                title: 'Mobil Optimallaşdırılmış',
                description: 'Əməkdaşlar və müştərilər üçün mükəmməl mobil təcrübə.',
                color: 'accent',
              },
              {
                icon: BarChart3,
                title: 'Analitika',
                description: 'Müştəri davranışlarını izləyin və biznesinizi optimallaşdırın.',
                color: 'emerald',
              },
              {
                icon: Users,
                title: 'Əməkdaş İdarəetməsi',
                description: 'Waiter hesabları yaradın və performansını izləyin.',
                color: 'amber',
              },
              {
                icon: Gift,
                title: 'Mükafat Sistemi',
                description: 'Özəl mükafat hədləri müəyyən edin və avtomatik tətbiq edin.',
                color: 'rose',
              },
              {
                icon: Sparkles,
                title: 'Sadə İstifadə',
                description: 'Kömpleks quraşdırma yoxdur. Dərhal istifadəyə başlayın.',
                color: 'violet',
              },
            ].map((feature, index) => (
              <div 
            ...
            {[
              {
                ...
                description: 'Paneldən istədiyiniz sayda QR kodlu kartlar yaradın və çap edin.',
                icon: QrCode,
              },
              {
                step: '02',
                title: 'Müştərilərə Təqdim Edin',
                description: 'Kartları müştərilərinizə verin. Onlar QR kodu telefonları ilə oxuda bilərlər.',
                icon: Users,
              },
              {
                step: '03',
                title: 'Xallar Toplayın',
                description: 'Hər gəlişdə xal əlavə edin və müştərilərinizi mükafatlandırın.',
                icon: Gift,
              },
            ].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-200 hover:shadow-xl transition-all">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Başlanğıc</h3>
              <div className="mb-6">
                <span className="text-4xl font-bold text-gray-900">₼29</span>
                <span className="text-gray-500">/ay</span>
              </div>
              <ul className="space-y-3 mb-8">
                {['100 aktiv kart', '2 əməkdaş', 'Baza analitika', 'Email dəstək'].map((item, i) => (
              ...
              <div className="relative bg-gradient-to-br from-primary-500 to-accent-500 rounded-2xl p-8 text-white shadow-2xl shadow-primary-500/30">
                ...
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    <li key={i} className={`flex items-center gap-3 ${item.startsWith('🎁') ? 'bg-white/20 -mx-2 px-2 py-1 rounded-lg font-medium' : ''}`}>
            ...
            {/* Enterprise Plan */}
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-primary-200 hover:shadow-xl transition-all">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Korporativ</h3>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={i} className={`flex items-center gap-3 text-gray-600 ${item.startsWith('🎁') ? 'bg-primary-50 -mx-2 px-2 py-1 rounded-lg' : ''}`}>
                    <Check className={`w-5 h-5 flex-shrink-0 ${item.startsWith('🎁') ? 'text-primary-500' : 'text-emerald-500'}`} />
                    <span>{item.startsWith('🎁') ? item.slice(2) : item}</span>
                  </li>
                ))}
              </ul>
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 px-4 bg-gradient-to-br from-slate-50 to-white">
